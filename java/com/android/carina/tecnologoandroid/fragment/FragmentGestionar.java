...
public class FragmentGestionar extends Fragment {
    private static final String ITEM_SELECCIONADO = "key_title";

    public FragmentGestionar() {
        // Required empty public constructor
    }

    public static FragmentGestionar newInstance(String titulo) {
        FragmentGestionar fragmentGestionar= new FragmentGestionar();
        Bundle args = new Bundle();
        args.putString(ITEM_SELECCIONADO, titulo);
        fragmentGestionar.setArguments(args);
